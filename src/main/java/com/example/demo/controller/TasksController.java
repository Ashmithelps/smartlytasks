...
public class TasksController {
    ...
    @GetMapping
    public ResponseEntity<Page<TasksResponseDto>> getAllTasks(@RequestParam (defaultValue = "0") int page, @RequestParam (defaultValue = "5") int size){
        Pageable pageable=PageRequest.of(page, size);
        Page<TasksResponseDto> tasks=tasksService.getAllTasks(pageable);
